...
LIBDIR = '/Users/alexanderconway/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-arch', 'i386', '-L/usr/local/mysql/lib', '-lmysqlclient_r', '-lpthread']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
MYSQL_CONFIG = '/usr/local/mysql/bin/mysql_config'
NODE_PATH = '/Users/alexanderconway/.node_libraries'
PREFIX = '/usr/local'
